...
export class TicketService {
  ...
  async create(createTicketDto: CreateTicketDto) {
   ...
   if(!isValidObjectId(eventId) || !isValidObjectId(seatId) || !isValidObjectId(ticketStatusId)){
  ...
  findAll() {
    return this.ticketSchema.find({}).populate("eventId").populate("seatId").populate("ticketStatusId")
  }
